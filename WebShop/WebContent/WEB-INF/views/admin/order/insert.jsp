...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<div id="insertItemForm">
				<form:form action="admin/order/insert/insertItem.html"
						...
						<tbody>
							...
							<c:forEach var="ci" items="${listOrderItem}">
								...
								<tr>
									...
									<td><a
										href="admin/order/insert/deleteItem/${ci.product.id}.html"
					...
					<ul style="list-style: none;">
						...
						<li>Tổng tiền phải trả: <span
							style="font-size: large; color: #FF4E00;"><fmt:formatNumber
								...
								đ</span></li>
						<li>Phương thức thanh toán: <label id="paymentLabel">COD</label></li>
			...
			<br>
			<form:form action="admin/order/insert.html" id="insertForm"
				modelAttribute="order" method="post">

				<form:hidden path="id" />
				<form:hidden path="status" value="0" />
				<form:hidden path="user.id" value="${adminLogin.id}" />
				...
				<div class="text-right">
					<button class="btn btn-primary" type="submit" id="submitButton">Thêm</button>
				</div>
			</form:form>
	...
	<script type="text/javascript">
		...
		productList.onchange = function(event) {
			...
			tPrice.textContent = Math.ceil(uPrice.value * qty.value).toFixed(0)
